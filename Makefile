...
HANDLER_OBJS=core/handlers/base.o core/handlers/hello.o core/handlers/simple_proxy.o core/handlers/file.o core/handlers/error.o
...
CXXFLAGS=-O0 -ggdb -Wall -Wextra -I. -fPIC -Icore
LDFLAGS=-shared
