...
HTTP_OBJS=core/http/connection.o core/http/request.o core/http/reply.o core/http/parser.o core/http/message.o
CORE_OBJS=core/main.o core/coroutine.o core/server.o
